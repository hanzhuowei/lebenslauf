...
%----------------------------------------------------------------------------------
\begin{document}
\includepdf[]{../deckblatt_han.pdf}
\includepdf[]{../TempAnschreiben/SignaSTC.pdf}
%-----       letter       ---------------------------------------------------------
% recipient data
% \recipient{}{}
...
\cventry[3pt]{09/2013 -- 03/2014}{Forschungsarbeit}{Robert Bosch GmbH}{Leonberg}{}{Thema: Optimierung und Validierung der Parameter der adaptiven Schwelle im ultraschallbasierten Detektionssystem\vspace{2mm} 
\begin{itemize}
\itemsep5pt
...
\section{Ausbildung}
\cventry{10/2012 -- 05/2015}{Master, Elektrotechnik und Informationstechnik}{Universität Stuttgart}{Vertiefung: Informationstechnik und Kommunikationstechnik (Note:1,9)}{\newline Masterarbeit: Deep Neural Network for Learning Speech Emotion Representation, Note: 1,0\vspace{2mm}
}{\begin{itemize}
 \itemsep5pt
 \item Erste Erfahrung in Mustererkennung und Machine Learning
%%  \item 
 \item Implementierung der komplexen Modelle und Algorithmen für Training
 \item Optimierung der Modellenparameter und Algorithmen
\end{itemize}}
